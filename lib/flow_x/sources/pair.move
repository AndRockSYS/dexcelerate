module flow_x::pair {
    ...
    public fun burn<T0, T1>(arg0: &mut PairMetadata<T0, T1>, arg1: &flow_x::treasury::Treasury, arg2: 0x2::coin::Coin<LP<T0, T1>>, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
		abort 0
    }
    ...
    public(package) fun create_pair<T0, T1>(arg0: &mut 0x2::tx_context::TxContext) : PairMetadata<T0, T1> {
		abort 0
    }
    ...
    public fun mint<T0, T1>(arg0: &mut PairMetadata<T0, T1>, arg1: &flow_x::treasury::Treasury, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<LP<T0, T1>> {
		abort 0
    }
    ...
    public(package) fun set_fee_rate<T0, T1>(arg0: &mut PairMetadata<T0, T1>, arg1: u64) {
		abort 0
    }
