module blue_move::swap {
    ...
    public struct Add_Liquidity_Pool has copy, drop {
        pool_id: 0x2::object::ID,
        user: address,
        token_x_name: 0x1::string::String,
        token_y_name: 0x1::string::String,
    ...
    public struct Remove_Liqidity_Pool has copy, drop {
        pool_id: 0x2::object::ID,
        user: address,
        token_x_name: 0x1::string::String,
        token_y_name: 0x1::string::String,
    ...
    public struct Swap_Event<phantom T0, phantom T1> has copy, drop {
        pool_id: 0x2::object::ID,
        user: address,
    ...
    public struct Freeze_Event has copy, drop {
        pool_id: 0x2::object::ID,
        token_x_in: 0x1::string::String,
        token_y_out: 0x1::string::String,
        lsp_balance: u64,
    ...
    public struct Dex_Info has store, key {
        id: UID,
        fee_to: address,
        dev: address,
    ...
    fun swap<T0, T1>(arg0: u64, arg1: u64, arg2: &mut Pool<T0, T1>, arg3: &mut TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        assert!(arg0 > 0 || arg1 > 0, 13);
        assert!(arg0 < arg2.reserve_x && arg1 < arg2.reserve_y, 7);
        let mut v0 = 0x2::coin::zero<T0>(arg3);
        let mut v1 = 0x2::coin::zero<T1>(arg3);
        if (arg0 > 0) {
        ...
        let v11 = if (v7 > 0 && v9 > 0 && 340282366920938463463374607431768211455 / v7 > v8 && 340282366920938463463374607431768211455 / v9 > v10) {
            ...
            let v12 = blue_move::u256::mul_u128(v7, v8);
            let v13 = blue_move::u256::mul_u128(v9, v10);
            blue_move::u256::ge(&v12, &v13)
        };
        assert!(v11, 15);
    ...
    public(package) fun add_liquidity<T0, T1>(arg0: u64, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: &mut Pool<T0, T1>, arg5: &mut TxContext) : (u64, u64, u64) {
        ...
        let v11 = Add_Liquidity_Pool{
            pool_id           : object::uid_to_inner(&arg4.id), 
            user              : v9, 
    ...
    fun add_liquidity_direct<T0, T1>(mut arg0: 0x2::coin::Coin<T0>, mut arg1: 0x2::coin::Coin<T1>, arg2: &mut Pool<T0, T1>, arg3: &mut TxContext) : (u64, u64, 0x2::coin::Coin<LSP<T0, T1>>, u64, 0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        let v0 = 0x2::coin::value<T0>(&arg0);
        let v1 = 0x2::coin::value<T1>(&arg1);
        let (v2, v3) = if (arg2.reserve_x == 0 && arg2.reserve_y == 0) {
            (v0, v1)
        } else {
            let v4 = blue_move::utils::quote(v0, arg2.reserve_x, arg2.reserve_y);
            let (v5, v6) = if (v4 <= v1) {
                (v0, v4)
            } else {
                let v7 = blue_move::utils::quote(v1, arg2.reserve_y, arg2.reserve_x);
                assert!(v7 <= v0, 8);
                (v7, v1)
            };
            (v5, v6)
        ...
        (v2, v3, v8, v9, 0x2::coin::split<T0>(&mut arg0, v0 - v2, arg3), 0x2::coin::split<T1>(&mut arg1, v1 - v3, arg3))
    }
    
    public fun add_swap_event_internal<T0, T1>(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: &mut Dex_Info, arg5: &mut TxContext) {
    ...
    public fun add_swap_event_with_address<T0, T1>(arg0: address, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: &mut Pool<T0, T1>) {
        let v0 = Swap_Event<T0, T1>{
            pool_id      : object::uid_to_inner(&arg5.id), 
            user         : arg0, 
    ...
    fun add_swap_event_with_address_internal<T0, T1>(arg0: address, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: &mut Dex_Info) {
        if (blue_move::utils::sort_token_type<T0, T1>()) {
            add_swap_event_with_address<T0, T1>(arg0, arg1, arg2, arg3, arg4, get_pool<T0, T1>(arg5));
        } else {
            add_swap_event_with_address<T1, T0>(arg0, arg2, arg1, arg4, arg3, get_pool<T1, T0>(arg5));
        };
    }
    ...
    fun burn<T0, T1>(arg0: 0x2::coin::Coin<LSP<T0, T1>>, arg1: &mut Pool<T0, T1>, arg2: &mut TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, u64) {
        let v0 = 0x2::coin::value<LSP<T0, T1>>(&arg0);
        assert!(v0 > 0, 7);
        let v1 = 0x2::balance::supply_value<LSP<T0, T1>>(&arg1.lsp_supply);
        let v2 = ((0x2::balance::value<T0>(&arg1.token_x) as u128) * (v0 as u128) / (v1 as u128)) as u64;
        let v3 = ((0x2::balance::value<T1>(&arg1.token_y) as u128) * (v0 as u128) / (v1 as u128)) as u64;
        assert!(v2 > 0 && v3 > 0, 10);
        0x2::balance::decrease_supply<LSP<T0, T1>>(&mut arg1.lsp_supply, 0x2::coin::into_balance<LSP<T0, T1>>(arg0));
        update<T0, T1>(0x2::balance::value<T0>(&arg1.token_x), 0x2::balance::value<T1>(&arg1.token_y), arg1);
        arg1.k_last = (arg1.reserve_x as u128) * (arg1.reserve_y as u128);
        (0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg1.token_x, v2), arg2), 0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg1.token_y, v3), arg2), mint_fee<T0, T1>(arg1))
    }
    ...
    public(package) fun create_new_pool<T0, T1>(arg0: &mut Dex_Info, arg1: &mut TxContext) {
        if (blue_move::utils::sort_token_type<T0, T1>()) {
    ...
    public entry fun create_new_pool_admin<T0, T1>(arg0: &mut Dex_Info, arg1: &mut TxContext) {
    ...
    fun create_pool_internal<T0, T1>(arg0: &mut Dex_Info, arg1: &mut TxContext) {
        ...
        let v5 = Created_Pool_Event{
            pool_id           : object::uid_to_inner(&v3), 
            creator           : v1, 
            token_x_name      : blue_move::utils::get_token_name<T0>(), 
            token_y_name      : blue_move::utils::get_token_name<T1>(), 
            token_x_amount_in : 0, 
    ...
    public entry fun freeze_pool<T0, T1>(arg0: bool, arg1: &mut Dex_Info, arg2: &mut TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg1.dev, 17);
        if (blue_move::utils::sort_token_type<T0, T1>()) {
            let v0 = get_pool<T0, T1>(arg1);
            v0.is_freeze = arg0;
            let v1 = Freeze_Event{
                pool_id     : object::uid_to_inner(&v0.id), 
                token_x_in  : blue_move::utils::get_token_name<T0>(), 
                token_y_out : blue_move::utils::get_token_name<T1>(), 
            ...
            v2.is_freeze = arg0;
            let v3 = Freeze_Event{
                pool_id     : object::uid_to_inner(&v2.id), 
                token_x_in  : blue_move::utils::get_token_name<T1>(), 
                token_y_out : blue_move::utils::get_token_name<T0>(), 
    ...
    public fun get_pool<T0, T1>(arg0: &mut Dex_Info) : &mut Pool<T0, T1> {
        ...
        0x2::dynamic_object_field::borrow_mut<0x1::string::String, Pool<T0, T1>>(&mut arg0.id, blue_move::utils::get_lp_name<T0, T1>())
    }
    ...
    fun mint<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &mut TxContext) : (0x2::coin::Coin<LSP<T0, T1>>, u64) {
        let v0 = 0x2::balance::value<T0>(&arg0.token_x);
        let v1 = 0x2::balance::value<T1>(&arg0.token_y);
        let v2 = 0x2::balance::supply_value<LSP<T0, T1>>(&arg0.lsp_supply) as u128;
        let v3 = if (v2 == 0) {
            let v4 = blue_move::math::sqrt(((v0 as u128) - (arg0.reserve_x as u128)) * ((v1 as u128) - (arg0.reserve_y as u128)));
            assert!(v4 > 1000, 4);
            0x2::balance::join<LSP<T0, T1>>(&mut arg0.minimum_liq, 0x2::balance::increase_supply<LSP<T0, T1>>(&mut arg0.lsp_supply, 1000 as u64));
            v4 - 1000
        } else {
            let v5 = blue_move::math::min(((v0 as u128) - (arg0.reserve_x as u128)) * v2 / (arg0.reserve_x as u128), ((v1 as u128) - (arg0.reserve_y as u128)) * v2 / (arg0.reserve_y as u128));
            assert!(v5 > 0, 4);
            v5
        };
        update<T0, T1>(v0, v1, arg0);
        arg0.k_last = (arg0.reserve_x as u128) * (arg0.reserve_y as u128);
        (0x2::coin::from_balance<LSP<T0, T1>>(0x2::balance::increase_supply<LSP<T0, T1>>(&mut arg0.lsp_supply, v3 as u64), arg1), mint_fee<T0, T1>(arg0))
    }
    
    fun mint_fee<T0, T1>(arg0: &mut Pool<T0, T1>) : u64 {
        let v0 = 0;
        if (arg0.k_last != 0) {
            let v1 = blue_move::math::sqrt((arg0.reserve_x as u128) * (arg0.reserve_y as u128));
            let v2 = blue_move::math::sqrt(arg0.k_last);
            if (v1 > v2) {
    ...
    public(package) fun remove_liquidity<T0, T1>(arg0: u64, arg1: 0x2::coin::Coin<LSP<T0, T1>>, arg2: &mut Pool<T0, T1>, arg3: &mut TxContext) : (u64, u64) {
        ...
        let v8 = Remove_Liqidity_Pool{
            pool_id            : object::uid_to_inner(&arg2.id), 
            user               : v7, 
            token_x_name       : blue_move::utils::get_token_name<T0>(), 
            token_y_name       : blue_move::utils::get_token_name<T1>(), 
    ...
    fun remove_liquidity_direct<T0, T1>(arg0: 0x2::coin::Coin<LSP<T0, T1>>, arg1: &mut Pool<T0, T1>, arg2: &mut TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, u64) {
        burn<T0, T1>(arg0, arg1, arg2)
    }
    
    public entry fun set_fee_to(arg0: &mut Dex_Info, arg1: address, arg2: &mut TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.dev, 17);
        arg0.fee_to = arg1;
    }
    
    public(package) fun swap_exact_x_to_y<T0, T1>(arg0: u64, arg1: 0x2::coin::Coin<T0>, arg2: address, arg3: &mut Pool<T0, T1>, arg4: &mut TxContext) : (u64, 0x2::coin::Coin<T1>) {
    ...
    public(package) fun swap_exact_x_to_y_direct<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: &mut Pool<T0, T1>, arg2: &mut TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        let v0 = 0x2::coin::value<T0>(&arg0);
        let v1 = v0 * 10 / 10000;
        ...
        let (v4, v5) = swap<T0, T1>(0, blue_move::utils::get_amount_out(v0 - v1, v2, v3), arg1, arg2);
        let v6 = v4;
        assert!(0x2::coin::value<T0>(&v6) == 0, 13);
        (v6, v5)
    }
    
    public(package) fun swap_exact_y_to_x<T0, T1>(arg0: u64, arg1: 0x2::coin::Coin<T1>, arg2: &mut Pool<T0, T1>, arg3: address, arg4: &mut TxContext) : (u64, 0x2::coin::Coin<T0>) {
        assert!(!arg2.is_freeze, 24);
    ...
    public(package) fun swap_exact_y_to_x_direct<T0, T1>(arg0: 0x2::coin::Coin<T1>, arg1: &mut Pool<T0, T1>, arg2: &mut TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let (v2, v3) = token_reserves<T0, T1>(arg1);
        let (v4, v5) = swap<T0, T1>(blue_move::utils::get_amount_out(v0 - v1, v3, v2), 0, arg1, arg2);
        let v6 = v5;
        assert!(0x2::coin::value<T1>(&v6) == 0, 13);
        (v4, v6)
    }
    
    public(package) fun swap_x_to_exact_y<T0, T1>(arg0: u64, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: address, arg4: &mut Pool<T0, T1>, arg5: &mut TxContext) : (u64, 0x2::coin::Coin<T1>) {
        assert!(!arg4.is_freeze, 24);
        assert_input_amount<T0>(arg0, &arg1);
    ...
    public(package) fun swap_x_to_exact_y_direct<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: u64, arg2: &mut Pool<T0, T1>, arg3: &mut TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
    ...
    public(package) fun swap_y_to_exact_x<T0, T1>(arg0: u64, arg1: 0x2::coin::Coin<T1>, arg2: u64, arg3: address, arg4: &mut Pool<T0, T1>, arg5: &mut TxContext) : (u64, 0x2::coin::Coin<T0>) {
        assert!(!arg4.is_freeze, 24);
        assert_input_amount<T1>(arg0, &arg1);
    ...
    public(package) fun swap_y_to_exact_x_direct<T0, T1>(arg0: 0x2::coin::Coin<T1>, arg1: u64, arg2: &mut Pool<T0, T1>, arg3: &mut TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
    ...
    public entry fun withdraw_fee<T0, T1>(arg0: &mut Dex_Info, arg1: &mut TxContext) {
