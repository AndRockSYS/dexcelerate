module move_pump::utils {
    ...
    public fun to_bytes(arg0: &U256) : vector<u8> {
        ...
        let v1 = get(arg0, 0);
        vector::append<u8>(&mut v0, bcs::to_bytes<u64>(&v1));
        let v2 = get(arg0, 1);
        vector::append<u8>(&mut v0, bcs::to_bytes<u64>(&v2));
        let v3 = get(arg0, 2);
        vector::append<u8>(&mut v0, bcs::to_bytes<u64>(&v3));
        let v4 = get(arg0, 3);
        vector::append<u8>(&mut v0, bcs::to_bytes<u64>(&v4));
        v0
    }
    ...
    public fun div(mut arg0: U256, mut arg1: U256) : U256 {
        ...
        loop {
            ...
            if (v5 == 2 || v5 == 0) {
                let v6 = v4 / 64;
				let ref = &v0;
                put(&mut v0, v6, get(ref, v6) | 1 << ((v4 % 64) as u8));
                let v7 = arg1;
                arg0 = sub(arg0, v7);
            };
            arg1 = shr(arg1, 1);
    ...
    public fun from_bytes(arg0: &vector<u8>) : U256 {
        assert!(vector::length<u8>(arg0) == 32, 4);
        let mut v0 = zero();
        put(&mut v0, 0, ((*vector::borrow<u8>(arg0, 0) as u64) << 7) + ((*vector::borrow<u8>(arg0, 1) as u64) << 6) + ((*vector::borrow<u8>(arg0, 2) as u64) << 5) + ((*vector::borrow<u8>(arg0, 3) as u64) << 4) + ((*vector::borrow<u8>(arg0, 4) as u64) << 3) + ((*vector::borrow<u8>(arg0, 5) as u64) << 2) + ((*vector::borrow<u8>(arg0, 6) as u64) << 1) + (*vector::borrow<u8>(arg0, 7) as u64));
        put(&mut v0, 1, ((*vector::borrow<u8>(arg0, 8) as u64) << 7) + ((*vector::borrow<u8>(arg0, 9) as u64) << 6) + ((*vector::borrow<u8>(arg0, 10) as u64) << 5) + ((*vector::borrow<u8>(arg0, 11) as u64) << 4) + ((*vector::borrow<u8>(arg0, 12) as u64) << 3) + ((*vector::borrow<u8>(arg0, 13) as u64) << 2) + ((*vector::borrow<u8>(arg0, 14) as u64) << 1) + (*vector::borrow<u8>(arg0, 15) as u64));
        put(&mut v0, 2, ((*vector::borrow<u8>(arg0, 16) as u64) << 7) + ((*vector::borrow<u8>(arg0, 17) as u64) << 6) + ((*vector::borrow<u8>(arg0, 18) as u64) << 5) + ((*vector::borrow<u8>(arg0, 19) as u64) << 4) + ((*vector::borrow<u8>(arg0, 20) as u64) << 3) + ((*vector::borrow<u8>(arg0, 21) as u64) << 2) + ((*vector::borrow<u8>(arg0, 22) as u64) << 1) + (*vector::borrow<u8>(arg0, 23) as u64));
        put(&mut v0, 3, ((*vector::borrow<u8>(arg0, 24) as u64) << 7) + ((*vector::borrow<u8>(arg0, 25) as u64) << 6) + ((*vector::borrow<u8>(arg0, 26) as u64) << 5) + ((*vector::borrow<u8>(arg0, 27) as u64) << 4) + ((*vector::borrow<u8>(arg0, 28) as u64) << 3) + ((*vector::borrow<u8>(arg0, 29) as u64) << 2) + ((*vector::borrow<u8>(arg0, 30) as u64) << 1) + (*vector::borrow<u8>(arg0, 31) as u64));
        v0
    }
    ...
    public fun shl(arg0: U256, arg1: u8) : U256 {
        ...
        if (v2 > 0) {
            ...
            while (v4 < 4) {
				let ref = &v0;
                put(&mut v0, v4, get(ref, v4) + (get(&arg0, v4 - 1 - v1) >> 64 - (v2 as u8)));
                v4 = v4 + 1;
            };
        };
        v0
    ...
    public fun shr(arg0: U256, arg1: u8) : U256 {
        ...
        if (v2 > 0) {
            ...
            while (v4 < 4) {
				let ref = &v0;
                put(&mut v0, v4 - v1 - 1, get(ref, v4 - v1 - 1) + (get(&arg0, v4) << 64 - (v2 as u8)));
                v4 = v4 + 1;
            };
        };
        v0
