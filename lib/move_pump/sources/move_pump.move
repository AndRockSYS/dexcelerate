module move_pump::move_pump {
    ...
    public entry fun buy<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut blue_move::swap::Dex_Info, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut TxContext) {
        ...
        let v6 = move_pump::curves::calculate_add_liquidity_cost(v2.virtual_sui_reserves, v2.virtual_token_reserves, v5) + 1;
        let v7 = move_pump::utils::as_u64(move_pump::utils::div(move_pump::utils::mul(move_pump::utils::from_u64(v6), move_pump::utils::from_u64(arg0.platform_fee)), move_pump::utils::from_u64(10000)));
        assert!(v3 >= v6 + v7, 6);
        ...
        let v11 = arg0.admin;
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg1, v7, arg5), v11);
        if (v4 == v5 || 0x2::coin::value<0x2::sui::SUI>(&v2.real_sui_reserves) >= 6000000000000) {
            transfer_pool<T0>(v2, arg2, v11, arg0.graduated_fee, arg4, arg5);
        };
        let v12 = TradedEvent{
            is_buy                 : true, 
            user                   : v0, 
    ...
    fun buy_direct<T0>(arg0: &mut blue_move::swap::Dex_Info, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut Pool<T0>, arg3: u64, arg4: u64, arg5: address, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut TxContext) {
        ...
        let v4 = move_pump::curves::calculate_add_liquidity_cost(arg2.virtual_sui_reserves, arg2.virtual_token_reserves, v3) + 1;
        let v5 = move_pump::utils::as_u64(move_pump::utils::div(move_pump::utils::mul(move_pump::utils::from_u64(v4), move_pump::utils::from_u64(arg4)), move_pump::utils::from_u64(10000)));
        assert!(v1 >= v4 + v5, 6);
    ...
    public fun buy_returns<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut blue_move::swap::Dex_Info, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<T0>) {
        ...
        let v5 = move_pump::curves::calculate_add_liquidity_cost(v1.virtual_sui_reserves, v1.virtual_token_reserves, v3) + 1;
        let v6 = move_pump::utils::as_u64(move_pump::utils::div(move_pump::utils::mul(move_pump::utils::from_u64(v5), move_pump::utils::from_u64(arg0.platform_fee)), move_pump::utils::from_u64(10000)));
        assert!(v4 >= v5 + v6, 6);
        ...
        let v10 = arg0.admin;
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg1, v6, arg5), v10);
        if (v2 == v3 || 0x2::coin::value<0x2::sui::SUI>(&v1.real_sui_reserves) >= 6000000000000) {
            transfer_pool<T0>(v1, arg2, v10, arg0.graduated_fee, arg4, arg5);
        };
        let v11 = TradedEvent{
            is_buy                 : true, 
    ...
    public entry fun create_and_first_buy<T0>(arg0: &mut Configuration, arg1: 0x2::coin::TreasuryCap<T0>, arg2: &mut blue_move::swap::Dex_Info, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: u64, arg5: &0x2::clock::Clock, arg6: 0x1::ascii::String, arg7: 0x1::ascii::String, arg8: 0x1::ascii::String, arg9: 0x1::ascii::String, arg10: 0x1::ascii::String, arg11: 0x1::ascii::String, arg12: 0x1::ascii::String, arg13: &mut TxContext) {
        ...
        if (0x2::coin::value<0x2::sui::SUI>(&arg3) > 0) {
            buy_direct<T0>(arg2, arg3, &mut v0, arg4, arg0.platform_fee, arg0.admin, arg0.graduated_fee, arg5, arg13);
        } else {
    ...
    public entry fun sell<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut TxContext) {
        ...
        assert!(v3 > 0, 2);
        let v4 = move_pump::curves::calculate_remove_liquidity_return(v2.virtual_token_reserves, v2.virtual_sui_reserves, v3);
        let v5 = move_pump::utils::as_u64(move_pump::utils::div(move_pump::utils::mul(move_pump::utils::from_u64(v4), move_pump::utils::from_u64(arg0.platform_fee)), move_pump::utils::from_u64(10000)));
        assert!(v4 - v5 >= arg2, 2);
    ...
    public fun sell_returns<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<T0>) {
        ...
        assert!(v2 > 0, 2);
        let v3 = move_pump::curves::calculate_remove_liquidity_return(v1.virtual_token_reserves, v1.virtual_sui_reserves, v2);
        let v4 = move_pump::utils::as_u64(move_pump::utils::div(move_pump::utils::mul(move_pump::utils::from_u64(v3), move_pump::utils::from_u64(arg0.platform_fee)), move_pump::utils::from_u64(10000)));
        assert!(v3 - v4 >= arg2, 2);
