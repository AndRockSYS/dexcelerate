module cetus_stable_farming::pool {
    ...
    use cetus_stable_farming::rewarder::{Self, RewarderManager};
    use cetus_stable_farming::config::{GlobalConfig, OperatorCap, checked_package_version, check_pool_manager_role };
    ...
    public struct WrappedPositionNFT has key, store {
        _id: UID,
        _pool_id: ID,
    ...
    public struct WrappedPositionInfo has store {
        _id: ID,
        _pool_id: ID,
        _clmm_pool_id: ID,
    ...
    public struct UpdateEffectiveTickRangeEvent has copy, drop {
        _pool_id: ID,
        _clmm_pool_id: ID,
        _effective_tick_lower: I32,
        _effective_tick_upper: I32,
    ...
    public struct AddRewardEvent has drop, copy {
        _pool_id: ID,
        _clmm_pool_id: ID,
        _rewarder: TypeName,
        _allocate_point: u64
    ...
    public struct UpdatePoolAllocatePointEvent has drop, copy {
        _pool_id: ID,
        _clmm_pool_id: ID,
    ...
    public struct HarvestEvent has drop, copy {
        _pool_id: ID,
        _wrapped_position_id: ID,
        _clmm_pool_id: ID,
        _clmm_position_id: ID,
    ...
    public struct AccumulatedPositionRewardsEvent has drop, copy {
        _pool_id: ID,
        _wrapped_position_id: ID,
        _clmm_position_id: ID,
    ...
    public struct AddLiquidityFixCoinEvent has drop, copy {
        _pool_id: ID,
        _wrapped_position_id: ID,
        _clmm_poo_id: ID,
        _clmm_position_id: ID,
    ...
    public fun deposit<CoinA, CoinB>(
        ...
        _pool: &mut Pool,
        _clmm_pool: &CLMMPool<CoinA, CoinB>,
        _clmm_pos: clmm_position::Position,
        _ctx: &mut TxContext
    ) {
        abort 0
    }
    ...
    public fun harvest<CoinA, CoinB>(
        _global_config: &GlobalConfig,
        _rewarder_manager: &mut RewarderManager,
        _pool: &mut Pool,
        _clmm_pool: &CLMMPool<CoinA, CoinB>,
